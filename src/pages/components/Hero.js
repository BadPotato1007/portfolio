...
const Hero = () => {
    ...
    <div class="ontop text-7xl text-green-50 pl-10">
        <br/><br/><br/><br/>
            ...
            <ReactTypingEffect typingDelay="500" eraseDelay="1200" text={["Web developer.", "Robotic engineer."]} className="bogname"/>
            
            
            <br/>


            <button class="big-btn relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium  rounded-lg group bg-gradient-to-br from-green-400 to-blue-600 group-hover:from-green-400 group-hover:to-blue-600 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800" >
            <span class="bit-btn relative px-5 py-2.5 transition-all ease-in duration-75 bg-gray-900 rounded-md group-hover:bg-transparent">
                Contact Me
            </span>
            </button>
